    ...
    if(message[:2] == '天氣'):
        ...
        if(not (city in cities)):
            ...
            carousel_template_message=CarouselTemplate(
                columns=[
                    CarouselColumn(
                        thumbnail_image_url='https://m.tianqi.com/static/wap2018/ico2/b1.png',
                        title='{} ~ {}'.format(res[0][0]['startTime'][5:-3], res[0][0]['endTime'][5:-3]),
                        text="天氣狀況 {}\n溫度 {} ~ {} °C\n降雨機率 {}".format(res[0][0]['parameter']['parameterName'], res[0][2]['parameter']['parameterName'], res[0][4]['parameter']['parameterName'], res[0][1]['parameter']['parameterName']),
                        actions=[
                            URIAction(
                    ...
                    CarouselColumn(
                        ...
                        text="天氣狀況 {}\n溫度 {} ~ {} °C\n降雨機率 {}".format(res[1][0]['parameter']['parameterName'], res[1][2]['parameter']['parameterName'], res[1][4]['parameter']['parameterName'], res[1][1]['parameter']['parameterName']),
                        actions=[
                            URIAction(
                                label='詳細內容', uri='https://www.cwb.gov.tw/V8/C/W/County/index.html'
                            )
                    ...
                    CarouselColumn(
                        ...
                        text="天氣狀況 {}\n溫度 {} ~ {} °C\n降雨機率 {}".format(res[2][0]['parameter']['parameterName'], res[2][2]['parameter']['parameterName'], res[2][4]['parameter']['parameterName'], res[2][1]['parameter']['parameterName']),
                        actions=[
                            URIAction(
                                label='詳細內容', uri='https://www.cwb.gov.tw/V8/C/W/County/index.html'
                            )
